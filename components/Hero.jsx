            ...
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                            ...
                            <span className='bg-green-600 px-3 py-1 max-sm:ml-1 rounded-full text-white text-xs'>Khuyến mãi</span> Miễn phí vận chuyển cho đơn hàng từ {currency}50! <ChevronRightIcon className='group-hover:ml-2 transition-all' size={16} />
                        </div>
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full bg-orange-200 rounded-3xl p-6 px-8 group'>
                        <div>
                            <p className='text-3xl font-medium bg-gradient-to-r from-slate-800 to-[#FFAD51] bg-clip-text text-transparent max-w-40'>Sản phẩm nổi bật</p>
                            <p className='flex items-center gap-1 mt-4'>Xem chi tiết <ArrowRightIcon className='group-hover:ml-2 transition-all' size={18} /> </p>
                        </div>
