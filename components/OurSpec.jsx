...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Đặc trưng nổi bật' description="Chúng tôi cung cấp dịch vụ chất lượng cao và trải nghiệm mua sắm an toàn, tiện lợi, không rắc rối." />
