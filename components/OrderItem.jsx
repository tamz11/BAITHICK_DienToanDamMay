                                ...
                                <div className="flex flex-col justify-center text-sm">
                                    ...
                                    <div>
                                        {ratings.find(rating => order.id === rating.orderId && item.product.id === rating.productId)
                                            ...
                                            : <button onClick={() => setRatingModal({ orderId: order.id, productId: item.product.id })} className={`text-green-500 hover:bg-green-50 transition ${!order.status.toUpperCase().includes("DELIVER") && 'hidden'}`}>Rate Product</button>
                                        }</div>
