...
export const ourSpecsData = [
    { title: "Miễn phí vận chuyển", description: "Giao hàng nhanh, miễn phí cho mọi đơn hàng — tin cậy và giao tận nơi.", icon: SendIcon, accent: '#05DF72' },
    { title: "Đổi trả trong 7 ngày", description: "Không hài lòng? Bạn có thể đổi trả sản phẩm trong vòng 7 ngày.", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "Hỗ trợ 24/7", description: "Hỗ trợ khách hàng chuyên nghiệp, sẵn sàng trợ giúp mọi lúc.", icon: HeadsetIcon, accent: '#A684FF' }
]
